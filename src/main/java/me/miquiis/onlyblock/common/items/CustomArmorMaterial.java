...
public enum CustomArmorMaterial implements IArmorMaterial {
    ...
    private CustomArmorMaterial(String name, int maxDamageFactor, int[] damageReductionAmountArray, int enchantability, SoundEvent soundEvent, float toughness, float knockbackResistance, Supplier<Ingredient> repairMaterial) {
        this.name = name;
    ...
    public String getName() {
        return OnlyBlock.MOD_ID + ":" + this.name;
    }
