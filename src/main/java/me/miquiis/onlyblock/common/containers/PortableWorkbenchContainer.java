...
public class PortableWorkbenchContainer extends RecipeBookContainer<CraftingInventory> {
   protected final CraftingInventory craftMatrix = new CraftingInventory(this, 3, 3);
   ...
   public PortableWorkbenchContainer(int id, PlayerInventory playerInventory, IWorldPosCallable p_i50090_3_) {
