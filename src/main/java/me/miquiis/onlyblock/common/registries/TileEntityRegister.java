...
public class TileEntityRegister {
    ...
    public static RegistryObject<TileEntityType<MoneyVacuumTileEntity>> MONEY_VACUUM = TILE_ENTITIES.register("money_vacuum", () ->
            TileEntityType.Builder.create(MoneyVacuumTileEntity::new, BlockRegister.VACUUM_BLOCK.get()).build(null)
    );
