...
public class NoobBezos extends MobEntity implements IAnimatable {

    private AnimationFactory factory = new AnimationFactory(this);

    public NoobBezos(EntityType<? extends MobEntity> type, World worldIn) {
        super(type, worldIn);
        this.setHealth(50);
    }
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<NoobBezos>(this, "controller", 10, this::predicate));
    }
