...
public class XpSheepRenderer extends SheepRenderer {

    private static final ResourceLocation SHEARED_SHEEP_TEXTURES = new ResourceLocation(OnlyBlock.MOD_ID, "textures/entity/xp_sheep.png");

    public XpSheepRenderer(EntityRendererManager renderManagerIn) {
        super(renderManagerIn);
        this.addLayer(new XpSheepWoolLayer(this));
    }
...
class XpSheepWoolLayer extends LayerRenderer<SheepEntity, SheepModel<SheepEntity>> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(OnlyBlock.MOD_ID, "textures/entity/xp_sheep_fur.png");
    private final SheepWoolModel<SheepEntity> sheepModel = new SheepWoolModel<>();

    public XpSheepWoolLayer(IEntityRenderer<SheepEntity, SheepModel<SheepEntity>> rendererIn) {
        super(rendererIn);
    }
