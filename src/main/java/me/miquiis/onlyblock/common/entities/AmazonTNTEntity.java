...
public class AmazonTNTEntity extends Entity {
    ...
    public AmazonTNTEntity(EntityType<? extends AmazonTNTEntity> type, World worldIn) {
        super(type, worldIn);
        this.preventEntitySpawning = true;
    }

    public AmazonTNTEntity(World worldIn, double x, double y, double z, @Nullable LivingEntity igniter) {
        this(EntityRegister.AMAZON_TNT.get(), worldIn);
