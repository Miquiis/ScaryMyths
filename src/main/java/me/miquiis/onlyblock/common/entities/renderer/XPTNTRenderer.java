...
public class XPTNTRenderer extends EntityRenderer<XPTNTEntity> {
    public XPTNTRenderer(EntityRendererManager renderManagerIn) {
        super(renderManagerIn);
        this.shadowSize = 0.5F;
    }

    @Override
    public ResourceLocation getEntityTexture(XPTNTEntity entity) {
        return PlayerContainer.LOCATION_BLOCKS_TEXTURE;
    }

    public void render(XPTNTEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
        matrixStackIn.push();
