...
public class FlyingTeslaEntity extends AnimalEntity implements IAnimatable {
    ...
    public FlyingTeslaEntity(EntityType<? extends AnimalEntity> entityTypeIn, World worldIn) {
    ...
    public FlyingTeslaEntity(World worldIn) {
        super(EntityRegister.FLYING_TESLA.get(), worldIn);
        this.preventEntitySpawning = true;
        this.ignoreFrustumCheck = true;
        setInvulnerable(true);
    }
    ...
    public void updatePassenger(Entity passenger) {
        Vector3d vector3d = (new Vector3d((double)0, 0.0D, 0.0)).rotateYaw(-this.rotationYaw * ((float)Math.PI / 180F) - ((float)Math.PI / 2F));
        passenger.setPosition(this.getPosX() + vector3d.x, this.getPosY() - 0.1f, this.getPosZ() + vector3d.z);
    }
