...
public class ElonMusk extends MonsterEntity implements IAnimatable {

    private AnimationFactory factory = new AnimationFactory(this);

    public ElonMusk(EntityType<? extends MonsterEntity> type, World worldIn) {
        super(type, worldIn);
        this.setHealth(50);
    }
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<ElonMusk>(this, "controller", 10, this::predicate));
    }
