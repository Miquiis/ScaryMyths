...
public class VanTwoEntity extends MobEntity implements IAnimatable {

    private AnimationFactory factory = new AnimationFactory(this);
    private double randomSpeed;
    private boolean isFirstMove;

    public VanTwoEntity(EntityType<? extends MobEntity> type, World worldIn) {
        super(type, worldIn);
        this.randomSpeed = MathUtils.getRandomMinMax(-0.2, 0.1);
    }

    public VanTwoEntity(World worldIn) {
        super(EntityRegister.VAN_TWO.get(), worldIn);
        this.randomSpeed = MathUtils.getRandomMinMax(-0.2, 0.1);
    }
    ...
    public void onCollideWithPlayer(PlayerEntity entityIn) {
        ...
        }else
        {
            ...
            currency.addOrSubtractAmount(-100000);
        }
