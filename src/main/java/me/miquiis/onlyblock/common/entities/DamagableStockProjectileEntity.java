...
public abstract class DamagableStockProjectileEntity extends ProjectileEntity {
    public double accelerationX;
    public double accelerationY;
    public double accelerationZ;

    public DamagableStockProjectileEntity(EntityType<? extends DamagableStockProjectileEntity> p_i50173_1_, World p_i50173_2_) {
        super(p_i50173_1_, p_i50173_2_);
    }

    public DamagableStockProjectileEntity(EntityType<? extends DamagableStockProjectileEntity> p_i50174_1_, double p_i50174_2_, double p_i50174_4_, double p_i50174_6_, double p_i50174_8_, double p_i50174_10_, double p_i50174_12_, World p_i50174_14_) {
    ...
    public DamagableStockProjectileEntity(EntityType<? extends DamagableStockProjectileEntity> p_i50175_1_, LivingEntity p_i50175_2_, double p_i50175_3_, double p_i50175_5_, double p_i50175_7_, World p_i50175_9_) {
