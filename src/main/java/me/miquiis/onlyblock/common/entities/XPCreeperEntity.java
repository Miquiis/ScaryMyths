...
public class XPCreeperEntity extends MonsterEntity implements IChargeableMob, IXPMob {
    ...
    public XPCreeperEntity(EntityType<? extends XPCreeperEntity> type, World worldIn) {
        super(type, worldIn);
    }

    public XPCreeperEntity(World worldIn) {
        super(EntityRegister.XP_CREEPER.get(), worldIn);
    }
...
class CreeperSwellGoal extends Goal {
    private final XPCreeperEntity swellingCreeper;
    private LivingEntity creeperAttackTarget;

    public CreeperSwellGoal(XPCreeperEntity entitycreeperIn) {
