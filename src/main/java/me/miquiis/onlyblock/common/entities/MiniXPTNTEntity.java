...
public class MiniXPTNTEntity extends Entity {
    ...
    public MiniXPTNTEntity(EntityType<? extends MiniXPTNTEntity> type, World worldIn) {
        super(type, worldIn);
        this.preventEntitySpawning = true;
        this.ORBS = new HashSet<>();
    }

    public MiniXPTNTEntity(World worldIn, double x, double y, double z, @Nullable LivingEntity igniter) {
        this(EntityRegister.MINI_XP_TNT.get(), worldIn);
