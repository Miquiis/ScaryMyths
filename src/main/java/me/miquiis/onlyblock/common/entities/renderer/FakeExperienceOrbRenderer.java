...
public class FakeExperienceOrbRenderer extends EntityRenderer<FakeExperienceOrbEntity> {
   ...
   public FakeExperienceOrbRenderer(EntityRendererManager renderManagerIn) {
      super(renderManagerIn);
      this.shadowSize = 0.15F;
      this.shadowOpaque = 0.75F;
   }

   protected int getBlockLight(FakeExperienceOrbEntity entityIn, BlockPos pos) {
      return MathHelper.clamp(super.getBlockLight(entityIn, pos) + 7, 0, 15);
   }

   public void render(FakeExperienceOrbEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
      matrixStackIn.push();
    ...
    */
   public ResourceLocation getEntityTexture(FakeExperienceOrbEntity entity) {
