...
@OnlyIn(Dist.CLIENT)
public class AshBookScreen extends Screen {

   public static final AshBookScreen.WrittenBookInfo RECIPE_BOOK = new WrittenBookInfo(new ArrayList<CraftRecipe>(
           Arrays.asList(
                   new DiamondBlockLBR()
           )
   ));

   public static final ResourceLocation BOOK_TEXTURES = new ResourceLocation(OnlyBlock.MOD_ID, "textures/gui/ash_book.png");
   private AshBookScreen.IBookInfo bookInfo;
   ...
   public AshBookScreen() {
      this(RECIPE_BOOK, true);
   }

   private AshBookScreen(AshBookScreen.IBookInfo bookInfoIn, boolean pageTurnSoundsIn) {
   ...
   @OnlyIn(Dist.CLIENT)
   public static class WrittenBookInfo implements AshBookScreen.IBookInfo {
